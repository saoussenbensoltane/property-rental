        ...
        <div class="register-container">
            <div class="register-card">
                ...
                <div class="register-header">
                    ...
                    <p class="header-subtitle">Sign up to get started</p>
                </div>
                ...
                <form #registerForm="ngForm" (ngSubmit)="onRegister()">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-error" *ngIf="passwordInput.invalid && passwordInput.dirty">
                            <span *ngIf="passwordInput.errors?.['required']">⚠️ Password is required</span>
                            <span *ngIf="passwordInput.errors?.['minlength']">⚠️ Minimum 8 characters</span>
                        </small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <p-select 
                            ...
                            styleClass="w-full"
                            [ngClass]="{'ng-invalid ng-dirty': roleInput.invalid && roleInput.dirty}"
                        ></p-select>
                        <small class="form-hint">🏠 Choose your profile type</small>
                        <small class="form-error" *ngIf="roleInput.invalid && roleInput.dirty">
                            ⚠️ Role is required
                        </small>
                    </div>
